...
public class OrderDto {
    ...
    public OrderDto(String token, Double totalPrice, ArrayList<Integer> prodIDs, ArrayList<Integer> quantities, String country, String province, String subrub, String city, String name, Integer areaCode) {
        this.token = token;
